...
- ✅ **VcXsrv Fix (v1.0.3)** - Resolved duplicate process conflicts
...
- Launch manually: In Ubuntu terminal, run `konsole`
- Verify installation: `which konsole`

See **README_INSTALLATION.md** for detailed troubleshooting.
