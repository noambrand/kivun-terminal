...
nsDialogs::Create 1018
  ...
  ${NSD_CreateDropList} 0 55u 100% 13u ""
  Pop $ConfigLanguage
...
Section "!Core Components (Required)" SecCore
  ...
  FileWrite $0 "#$\r$\n"
  FileWrite $0 "# Options: english, hebrew$\r$\n"
  ...
  CreateDirectory "$LOCALAPPDATA\Microsoft\Windows Terminal\Fragments\KivunTerminal"
  CopyFiles /SILENT "$INSTDIR\kivun-wt-fragment.json" "$LOCALAPPDATA\Microsoft\Windows Terminal\Fragments\KivunTerminal\kivun-wt-fragment.json"
